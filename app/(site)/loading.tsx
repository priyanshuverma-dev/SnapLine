...
const loading = () => {
  return (
    <div>
      <div className="font-sans flex text-center sm:flex-row sm:text-left justify-between py-4 px-6 bg-white dark:bg-neutral-900 shadow-lg sm:items-baseline w-full ">
